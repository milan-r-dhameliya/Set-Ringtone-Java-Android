package com.example.set_ringtone_native_android;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    String myDownloadedRingtonePath = "/storage/emulated/0/Ringtones/ringtone.mp3";

                    settingRingtone(myDownloadedRingtonePath, guessMimeTypeFromExtension(myDownloadedRingtonePath),
                            true, false, false);

                    Toast.makeText(getApplicationContext(), "Set as ringtone successfully ", Toast.LENGTH_SHORT).show();

                } catch (Exception e) {
                    Log.i("MilanError",e.toString());
    ...
    /* Get Files MimeType From File Path */
    ...
    /* Get Files MimeType From File Path String */
    ...
    /* Requesting For Writting Setting Permission */
    ...
    /* Checking If Request Write Permission Granted Or not  */
    ...
    /* Setting Ringtone Function  */
    private void settingRingtone(String path, String downloadedMimeType, boolean isRingt, boolean isNotif, boolean isAlarm) {
        ...
        if (mFile.exists()) {
            ...
            if (android.os.Build.VERSION.SDK_INT > 28) {// file.exists
                ...
                if (isNotif) {
                    ...
                    Toast.makeText(getApplicationContext(), "Setted Notification Ringtone ", Toast.LENGTH_SHORT).show();
                ...
                if (isRingt) {
                    ...
                    Toast.makeText(getApplicationContext(), "Setted Caller Ringtone ", Toast.LENGTH_SHORT).show();
                ...
                if (isAlarm) {
                    ...
                    Toast.makeText(getApplicationContext(), "Setted Alarm Ringtone ", Toast.LENGTH_SHORT).show();
